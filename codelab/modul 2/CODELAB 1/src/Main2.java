...
public class Main2 {
    public static void main(String[] args){
        RekeningBank Rekening1 = new RekeningBank("202410370110149", "masdar helmi faila syifa", 5000000);
        RekeningBank Rekening2 = new RekeningBank("202410370110136", "rudi",3000000);
